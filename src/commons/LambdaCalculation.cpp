...
public:
    ...
    static std::vector<double> solve_probabilities_from_lambda(const Matrix& score_matrix, double lambda, 
                                                       double tolerance = LambdaCalculationConstants::POWER_ITERATION_TOLERANCE, int max_iterations = LambdaCalculationConstants::MAX_POWER_ITERATIONS) {
  int n = score_matrix.row_dim;
  std::vector<double> empty_result;
