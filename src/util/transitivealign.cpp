...
#pragma omp parallel
        {
            ...
            Matcher matcher(querySeqType, par.maxSeqLen, subMat, &evaluer,
                            par.compBiasCorrection, par.compBiasCorrectionScale, par.gapOpen.values.aminoacid(), par.gapExtend.values.aminoacid(), 0.0, par.zdrop, par.compBiasCorrectionWLocal);
